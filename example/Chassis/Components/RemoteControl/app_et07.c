...
void Get_ET07_DataDecode(ET07_Data_t* et07_data_t, uint8_t* rx_buf) {
  ...
  if (rx_buf[0] == 0x0f && rx_buf[24] == 0x00)  // sbus
  {
    et07_data_t->RightTransverse_CH1 =
      ((int16_t)rx_buf[1] >> 0 | ((int16_t)rx_buf[2] << 8)) & 0x07FF;
    et07_data_t->RightDirection_CH2 =
      ((int16_t)rx_buf[2] >> 3 | ((int16_t)rx_buf[3] << 5)) & 0x07FF;
    et07_data_t->LeftDirection_CH3 =
      ((int16_t)rx_buf[3] >> 6 | ((int16_t)rx_buf[4] << 2) | (int16_t)rx_buf[5] << 10) & 0x07FF;
    et07_data_t->LeftTransverse_CH4 =
      ((int16_t)rx_buf[5] >> 1 | ((int16_t)rx_buf[6] << 7)) & 0x07FF;
    et07_data_t->SA_CH5 = ((int16_t)rx_buf[6] >> 4 | ((int16_t)rx_buf[7] << 4)) & 0x07FF;
    et07_data_t->SB_CH6 =
      ((int16_t)rx_buf[7] >> 7 | ((int16_t)rx_buf[8] << 1) | (int16_t)rx_buf[9] << 9) & 0x07FF;
